...
public class SftpRxJava {
    ...
    public SftpRxJava(FileTransType fileTransType, String location) {
        ...
        UI_FILE_NAME = (fileTransType == FileTransType.FIRMWARE || fileTransType == FileTransType.SIGNED_FIRMWARE) ? "DEVS100D12.apk" :
    ...
    public void doVersionCheck() {
        try {
            ...
            if (Objects.equals(checkTime, 0)) {
                boolean versionCheck = ((MainActivity) MainActivity.mContext).getChargingCurrentData().isReBoot();
